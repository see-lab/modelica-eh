...
model GridWithPV "Linear model with electric grid and PV panels"
  extends GridOnly(
    CCap=capExOnePV*nPV,
    PGen(y=pv.P));
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.PVSimpleOriented pv(
    ...
    til=0,
    azi=0,
    V_nominal=V_nominal) "Solar pannel with orientation"
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://EnergyHub/Resources/Scripts/Dymola/Examples/Linear/GridWithPV.mos"
        "Simulate and plot"),
